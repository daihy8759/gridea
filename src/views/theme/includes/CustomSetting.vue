            ...
            >
              ...
              <div v-if="item.type === 'picture-upload'" style="display: flex;">
                ...
                >
                  <div
                    v-if="
                      form[item.name] && form[item.name].startsWith('/media/')
                    "
                  >
                    <img
                      class="picture"
              ...
              <div v-if="item.type === 'array'">
                ...
                >
                  <div
                    v-for="(field, fieldIndex) in item.arrayItems"
                    :key="fieldIndex"
                  >
                    <a-form-item
                      :label="field.label"
                    ...
                    >
                      ...
                      >
                        ...
                        <a-input
                          ...
                          v-if="
                            field.type === 'input' && field.card === 'color'
                          "
                          :placeholder="field.note"
                          v-model="configItem[field.name]"
                        >
                          <div
                            ...
                            :style="{ backgroundColor: configItem[field.name] }"
                          ></div>
                        </a-input>
                      </a-popover>
                      ...
                      <!-- picture-upload 类型 -->
                      <div
                        v-if="field.type === 'picture-upload'"
                        style="display: flex;"
                      >
                        <a-upload
                          action=""
...
export default class ThemeCustomSetting extends Vue {
  ...
  getPostTitleByLink(link: string) {
    const foundPost = this.postsWithLink.find(
      (post: any) => post.link === link,
    )
